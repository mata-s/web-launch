...
type ServicesCuteProps = {
  section: ServicesSectionData;
};

export default function ServicesCute({ section }: ServicesCuteProps) {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-rose-700 sm:text-base sm:leading-8">
            やさしく親しみやすい雰囲気で、サービス内容をかわいく分かりやすく紹介します。
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {section.items.map((item, index) => (
            ...
            >
              ...
              <h4 className="mt-6 break-keep text-2xl font-bold text-rose-950">
                {item.title}
              </h4>
