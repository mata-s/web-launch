...
export default function ServicesDark({ section }: ServicesDarkProps) {
  return (
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-sm leading-7 text-zinc-400 sm:text-base sm:leading-8">
            強い世界観を持つサービス内容を、ダークトーンとネオンアクセントで印象的に見せます。
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {section.items.map((item, index) => (
            ...
            >
              ...
              <h4 className="relative mt-6 break-keep text-2xl font-bold text-white">
                {item.title}
              </h4>
