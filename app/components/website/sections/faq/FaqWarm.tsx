...
export default function FaqWarm({ section }: FaqWarmProps) {
  return (
        ...
        <div className="mt-12 space-y-4">
          {section.items.map((item, index) => (
            <article
              ...
              className="rounded-2rem border border-amber-100 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl sm:p-7"
            >
              <div className="flex gap-5">
                ...
                <div>
                  <h4 className="break-keep text-lg font-bold leading-7 text-stone-900 sm:text-xl">
                    {item.question}
                  </h4>
